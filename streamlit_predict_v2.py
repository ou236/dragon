...
with st.sidebar:
    st.image(r'C:/Users/dell/Downloads/rigth_logo.png',width=100)
    st.title('请选择页面')
...
该数据集记录了 344 行观测数据，包含 3 个不同物种的企鹅：阿德利企鹅、巴布亚企鹅和帽带企鹅的各种信息。""")
    st.header('三种企鹅的卡通图像')
    st.image(r'C:/Users/dell/Downloads/penguins.png')
    ...
    with col_logo:
        if not submitted:
            st.image(r'C:/Users/dell/Downloads/rigth_logo.png',width=300)
        else:
            st.image(r'C:/Users/dell/Downloads/阿德利企鹅.png',width=300)
